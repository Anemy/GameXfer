    ...
    toolbar: {
      handlers: {
        ...
        image: function image() {
          ...
          // HACK (RHYS): This inserts the image node where the user is typing. 
          // The default quill behavior used to be to upload an image.
          ...
          while (true) {
            ...
            // Check to make sure it's an image url.
            // If it's not then we just prompt again.
